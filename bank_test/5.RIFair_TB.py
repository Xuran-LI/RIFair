...
import keras
import numpy
from utils.utils_RIFair import split_model_by_embedding_layer, true_bias
...
def TrueBiasedAdv(file1, files2, files3, files4, times, size1, size2, index):
    """
    进行准确公平性测试
    :return:
    """
    ...
    for i in range(label1.shape[0]):
        ...
        result = true_bias(models, label1[i], [index1[i], value1[i]], [index2, value2],
...
def TrueBiasedRetrain(file1, files2, files3, files4, times, size1, size2, index):
    """
    进行准确公平性测试
    :return:
    """
...
if __name__ == "__main__":
    ...
    age_result = ["../dataset/bank/adv/TB_{}_i.txt".format("age_AutoInt_BL0"),
                  "../dataset/bank/adv/TB_{}_s.txt".format("age_AutoInt_BL0"),
                  "../dataset/bank/adv/TB_{}_y.txt".format("age_AutoInt_BL0"),
                  "../dataset/bank/adv/TB_{}_t.txt".format("age_AutoInt_BL0")]
    TrueBiasedAdv(M_file, data_file, age_file, age_result, search_time, feature_size, embed_size, age)
    ...
    age_result = ["../dataset/bank/retrain/TB_{}_i.txt".format("age_AutoInt_BL0"),
                  "../dataset/bank/retrain/TB_{}_s.txt".format("age_AutoInt_BL0"),
                  "../dataset/bank/retrain/TB_{}_y.txt".format("age_AutoInt_BL0"),
                  "../dataset/bank/retrain/TB_{}_t.txt".format("age_AutoInt_BL0")]
    TrueBiasedRetrain(M_file, data_file, age_file, age_result, search_time, feature_size, embed_size, age)
